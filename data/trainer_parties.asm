...
; Route 3
	...
	db 14,RATTATA,EKANS,ZUBAT,0 ; X
	db 15,RATTATA,SPEAROW,0 ; X
	db 17,SLOWPOKE,0 ; X
	db 14,EKANS,SANDSHREW,0 ; X
	db 21,NIDORAN_M,0
	db 21,EKANS,0
...
; Route 3
	...
	db 14,CLEFAIRY,0
	db 16,PIDGEY,NIDORAN_F,0 ; X
	db 14,PIDGEY,NIDORAN_F,0 ; X
	db 15,NIDORAN_M,NIDORAN_F,0 ; X
	db 13,ODDISH,PIDGEY,ODDISH,0 ; X
...
HikerData:
	...
	db 15,MACHOP,GEODUDE,0 ; X
	db 13,GEODUDE,GEODUDE,MACHOP,GEODUDE,0 ; X
	db 17,ONIX,0 ; X
