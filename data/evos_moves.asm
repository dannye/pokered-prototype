...
;SCYTHER
;Evolutions
	db EV_ITEM,LEAF_STONE,1,SCIZOR
	db 0
;Learnset
	db 17,LEER
	db 20,FOCUS_ENERGY
...
;SLOWPOKE
;Evolutions
	db EV_FUSE,1,SHELLDER,1,SLOWKING
	db EV_FUSE,0,SHELLDER,1,SLOWBRO
	db 0
;Learnset
	db 18,DISABLE
	db 22,HEADBUTT
...
;KOFFING
;Evolutions
	db EV_FUSE,0,KOFFING,1,WEEZING
	db 0
;Learnset
	db 32,SLUDGE
	db 37,SMOKESCREEN
...
;DIGLETT
;Evolutions
	db EV_FUSE,0,DIGLETT,2,DUGTRIO
	db 0
;Learnset
	db 15,GROWL
	db 19,DIG
...
;TYROGUE
;Evolutions
	db EV_STAT,2,20,HITMONLEE
	db EV_STAT,1,20,HITMONCHAN
	db EV_STAT,0,20,HITMONTOP
	db 0
;Learnset
	db 30,ROLLING_KICK
	db 33,FIRE_PUNCH
...
;MAGNEMITE
;Evolutions
	db EV_FUSE,0,MAGNEMITE,2,MAGNETON
	db 0
;Learnset
	db 21,SONICBOOM
	db 25,THUNDERSHOCK
