...
PalPacket_PartyMenu:      PAL_SET PAL_PARTYMENU, PAL_GREENBAR, PAL_YELLOWBAR, PAL_REDBAR
...
PalPacket_Titlescreen:    PAL_SET PAL_LOGO2, PAL_LOGO1, PAL_MEWTWO, PAL_PURPLEMON
